...
?>
	...
	<form action="options.php" method="post">
		...
		<p>
			<?php
			$documentation_link = '<a title="' . esc_attr__( 'Custom Post Type Membership Access Add On Documentation', 'pmpro-cpt' ) . '" target="_blank" rel="nofollow noopener" href="https://www.paidmembershipspro.com/add-ons/custom-post-type-membership-access/?utm_source=plugin&utm_medium=pmpro-cpt&utm_campaign=add-ons">' . esc_html__( 'Custom Post Type Membership Access Add On', 'pmpro-cpt' ) . '</a>';
			/* translators: %s: link to the Custom Post Type Membership Access Add On documentation */
